...
Proceed to run the code.''')
        ...
        print(
'''The following is a hardcoded simple FOR LOOP that prints number of iterations.\n
...
''')
        ...
        print(
'''
RANGE CONTROL EXAMPLE\n
To control range in a for loop, it can be declared as\n
    for i in range (1, 4):
    print(i)\n

The RANGE CONTROL the above example starts at 1, and ALWAYS END AT THE HIGHEST DECLARED NUMBER - 1.\n")
...
''')
    ...
    def eLoopControl():
        ...
        print(
'''Sometimes loop readability is in itself valuable. Especially if work with
